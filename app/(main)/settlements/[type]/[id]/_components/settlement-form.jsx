        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {groupMembers.map((member) => {
              ...
              const isOwing = member.netBalance < 0; // negative means they owe you or/ you are owed by them
              const isOwed = member.netBalance > 0; // positive means you owe them or/ they are owed by you
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      {isOwing
                        ? `is owed $${Math.abs(member.netBalance).toFixed(2)} by you` // Don't go into english grammar here :D
                        : isOwed
                          ? `owes you $${Math.abs(member.netBalance).toFixed(2)}`
                          : "Settled up"}
                    </div>
                  </div>
                </div>
